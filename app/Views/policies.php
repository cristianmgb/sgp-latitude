...
<?= $this->section('content') ?>
			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-2">
							<button class="btn btn-sm btn-block btn-primary" type="button" data-toggle="modal" data-target="#newPolicy">
								Nueva Póliza
							</button>
						</div>
					</div>
	...
	<div class="modal fade" id="newPolicy" tabindex="-1" aria-labelledby="newPolicy" aria-hidden="true">
	  	<div class="modal-dialog">
	    	<div class="modal-content">
		     	<div class="modal-header">
		        	<h5 class="modal-title" id="newPolicy">
		        		<i class="fas fa-vote-yea"></i> Nueva Póliza
		        	</h5>
